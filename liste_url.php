    ...
    <table class="table table-dark table-hover ">
       ...
       <?php
        ...
        $sql = "SELECT * FROM table_url WHERE valide='0' and motif=''";
          ...
          <tr>
            ...
            <td> 
                <!-- <form methode name="form_validation"> -->
                     ...
                     <button class="btn btn-success" onclick="valide_url(<?php echo $row['id_url'] ;?>)">valide</button>
                     <button class="btn btn-danger" onclick="non_valide_url(<?php echo $row['id_url'] ;?>)" data-toggle="modal" data-target="#motif"> non valide</button>
                <!-- </form> -->
            </td>
